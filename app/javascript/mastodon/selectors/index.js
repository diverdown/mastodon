...
export const makeGetAccount = () => {
  return createSelector([getAccountBase, getAccountCounters, getAccountRelationship, getAccountOAuthAuthorizations], (base, counters, relationship, oauthAuthorizations) => {
    if (base === null) {
      return null;
    }

    return base.merge(counters).set('relationship', relationship).set('oauth_authorizations', oauthAuthorizations);
  });
};
